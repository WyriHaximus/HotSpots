...
class ColorTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testSetGet() {
        $color = new \HotSpots\Color(1, 2, 3, 4);
    ...
    public function testMin() {
        $color = new \HotSpots\Color(0, 0, 0, 0);
    ...
    public function testMax() {
        $color = new \HotSpots\Color(255, 255, 255, 127);
    ...
    public function testUnderMin() {
        $color = new \HotSpots\Color(-1, -2, -3, -1);
    ...
    public function tesOverMax() {
        $color = new \HotSpots\Color(256, 257, 258, 128);
    ...
    public function testNonIntString() {
        $color = new \HotSpots\Color('a', 'b', 'c', 'd');
