...
namespace WyriHaximus\HotSpots\Test\Renderer;
...
class Gdtest extends \PHPUnit_Framework_TestCase {
    ...
    public function testImageRender() {
        ...
        $Renderer = new \WyriHaximus\HotSpots\Renderer\Gd(array(
            'height' => 256,
            'width' => 256,
        ), new \WyriHaximus\HotSpots\Colors\Image('Classic'), 50);
        ...
        $Renderer->render($Matrix, new \WyriHaximus\HotSpots\Writer\File($this->tmpDir . DIRECTORY_SEPARATOR . 'GdTest.png'));
    ...
    public function testImageRenderAlpha() {
        ...
        $Renderer->render($Matrix, new \WyriHaximus\HotSpots\Writer\File($this->tmpDir . DIRECTORY_SEPARATOR . 'GdTestAlpha.png'));
