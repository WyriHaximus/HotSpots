 ...
 */
class ImageTest extends \WyriHaximus\HotSpots\Test\AbtractColorsTest {
    
    public function setUp() {
        $this->Colors = new \WyriHaximus\HotSpots\Colors\Image('Classic');
    }
    ...
    public function testGetColorAlpha() {
        ...
        unset($this->Colors);
        $this->Colors = new \WyriHaximus\HotSpots\Colors\Image('ClassicAlpha');
    ...
    /**
     * @expectedException \WyriHaximus\HotSpots\Exceptions\FileNotFoundException
     */
    public function testNonexistingImage() {
        // Overwriting default image used
        unset($this->Colors);
        $this->Colors = new \WyriHaximus\HotSpots\Colors\Image('NonexistingImageFile');
    }
